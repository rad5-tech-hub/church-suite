    ...
    <AdminDashboardManager>
      <div className="p-6 space-y-8 bg-gray-50 min-h-screen">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {/* Open Tickets */}
          <div className="bg-white rounded-2xl p-6 shadow-sm border-l-4 border-red-500 flex flex-col gap-5">
            <div>
          ...
          {/* In Progress */}
          <div className="bg-white rounded-2xl p-6 shadow-sm border-l-4 border-blue-500 flex flex-col gap-5">
            <div>
          ...
          {/* Resolved */}
          <div className="bg-white rounded-2xl p-6 shadow-sm border-l-4 border-green-500 flex flex-col gap-5">
            <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex gap-3 w-full sm:w-auto">
            <select className="px-4 py-2.5 bg-white border border-gray-300 rounded-xl text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
              ...
              <tbody className="divide-y divide-gray-200">
                {[
                  ...
                  <tr key={i} className="hover:bg-gray-50 transition">
                    <td className="px-6 py-4 text-sm font-medium text-gray-900">{ticket.church}</td>
