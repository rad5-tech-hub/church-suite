  ...
  return (
    ...
    >
      <CardContent sx={{ pb: "0 !important" }}>
        ...
        <Typography variant="h6" sx={{ color: "var(--color-text-primary)", fontWeight: "bold", mb: 1 }}>
          {value}
        </Typography>
    ...
    <DashboardManager>
      <Box sx={{ p: { xs: 2, md: 3 } }}>
          ...
          <Grid container spacing={3} sx={{ mb: 4 }}>
            {dashboardData.structure.totalBranches !== undefined && (
              <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                <StatCard
                  ...
                  icon={<TbArrowFork className="text-[24px]" />}
                  color="#2196F3"
                />
              </Grid>
            )}
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <StatCard
                ...
                icon={<TbArrowBearRight2 className="text-[24px]" />}
                color="#FF9800"
              />
            </Grid>
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <StatCard
                ...
                icon={<MdOutlineHub className="text-[24px]" />}
                color="#607D8B"
              />
            </Grid>
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <StatCard
                ...
                icon={<FaPeopleCarry className="text-[24px]" />}
                color="#9C27B0"
              />
            </Grid>
          </Grid>
        ...
        <Grid container spacing={3} sx={{ mb: 4, p: 3, background: "var(--color-surface-glass)", borderRadius: "16px", border: "1px solid var(--color-border-glass)" }}>
          <Grid size={12} sx={{ display: "flex", justifyContent: "flex-end" }}>
            <FormControl sx={{ minWidth: 120 }}>
              <InputLabel sx={{ color: "var(--color-text-secondary)" }}>View</InputLabel>
              <Select
                value={view}
                ...
                sx={{
                  ...
                  "& .MuiOutlinedInput-notchedOutline": { borderColor: "var(--color-border-glass)" },
                  "&:hover .MuiOutlinedInput-notchedOutline": { borderColor: "var(--color-border-glass)" },
                }}
              >
          ...
          {isBranch && dashboardData.followUps && (
            <Grid size={{ xs: 12, sm: 6 }}>
              <StatCard
                ...
                icon={<FaPeopleGroup className="text-[24px]" />}
                color="#00BCD4"
              />
            </Grid>
          )}
          ...
          <Grid size={{ xs: 12, sm: 6 }}>
            <StatCard
              ...
              icon={<CiMoneyBill className="text-[30px]" />}
              color="#795548"
            />
          </Grid>
        </Grid>
        ...
        <Grid size={12} sx={{ mb: 4 }}>
          ...
          >
            <Typography variant="h6" sx={{ color: "var(--color-text-primary)", mb: 2, fontWeight: "bold" }}>
        ...
        <Grid container spacing={3}>
          {isBranch && (
            <Grid size={{ xs: 12, md: 8 }}>
              ...
              >
                <Typography variant="h6" sx={{ color: "var(--color-text-primary)", mb: 3, fontWeight: "bold" }}>
                  Quick Actions
                </Typography>
