  ...
  const handleConfirmedAction = async () => {
    ...
    try {
      ...
      if (actionType === "delete") {
        ...
        fetchMembers(); // Refresh the list to show updated status
      }
    } catch (error) {
  ...
  return (
    <DashboardManager>
      <Box sx={{ py: 4, px: { xs: 2, sm: 3 }, minHeight: "100%" }}>
                  ...
                  {members
                    ...
                    .map((member) => (
                      <TableRow key={member.id} sx={{
                        ...
                        backgroundColor: member.isDeleted ? 'rgba(0, 0, 0, 0.04)' : 'inherit',
                          ...
                          <Box>
                            <Typography
                              sx={{
                                ...
                                alignItems: 'center',
                                fontSize: isLargeScreen ? '0.875rem' : undefined,                                
                                color: member.isDeleted ? 'gray' : 'text.secondary',
                                textDecoration: member.isDeleted ? 'line-through' : 'none',
                              }}
                            >
                            ...
                            >
                              <WhatsAppIcon sx={{ fontSize: '1rem', marginRight: 1, color: '#25D366' }} />
        ...
        >
          <MenuItem onClick={() => navigate(`/members/view/${currentMember?.id}`)} disabled={currentMember?.isDeleted}>
