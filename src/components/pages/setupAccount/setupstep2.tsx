        ...
        <div className="form-section flex-1 bg-white w-full rounded-b-lg md:rounded-r-lg md:rounded-b-none px-6 lg:px-12 py-10 flex flex-col">
          ...
          <form className="flex flex-col">
            ...
            <div className="mb-6">
                ...
                <div className="file-upload input-shadow flex flex-col items-center justify-center border border-gray-300 rounded-md py-6 cursor-pointer relative">
                    <input
                    type="file"
                    id="logo-upload"
            ...
            <div className="flex flex-col-reverse lg:flex-row lg:justify-between gap-3 pt-5">
              {/* Skip Button */}
              <Link to={'/setting-up'} className="flex items-center">
                <button
                  type="button"
